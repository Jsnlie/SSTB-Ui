...
export default function EditKegiatanPage() {
  ...
  const [imageName, setImageName] = useState("kebaktian-kampus.jpg");
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              type="text"
              defaultValue="Kebaktian Kebangunan Rohani Kampus"
              required
          ...
          <div>
            ...
            <textarea
              rows={5}
              defaultValue="Kebaktian kebangunan rohani kampus yang diadakan untuk seluruh civitas academica sebagai wujud komitmen iman dan pelayanan bersama dalam kampus."
              required
