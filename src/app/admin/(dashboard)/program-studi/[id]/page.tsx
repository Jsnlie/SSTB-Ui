      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              type="text"
              defaultValue="Sarjana Teologi (S.Th.)"
              required
          ...
          <div>
            ...
            <textarea
              rows={4}
              defaultValue="Program studi Sarjana Teologi bertujuan menghasilkan lulusan yang memiliki kompetensi teologis dan keterampilan pelayanan gereja yang berkualitas."
