...
export default function TambahKompetensiPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(message || "Gagal menyimpan kompetensi");
      }
      ...
      if (err instanceof Error) {
        ...
        setError("Terjadi kesalahan saat menyimpan kompetensi");
      }
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 max-w-2xl">
        <h2 className="text-lg font-semibold text-gray-800 mb-6">Tambah Kompetensi</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              required
              placeholder="Contoh: Kompetensi Utama"
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={8}
              placeholder="Satu baris untuk satu item kompetensi"
