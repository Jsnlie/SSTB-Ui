...
export default function EditBeritaPage() {
  ...
  const [imageName, setImageName] = useState("berita-akreditasi.jpg");
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              type="text"
              defaultValue="STT Bandung Meraih Akreditasi A dari BAN-PT"
              required
          ...
          <div>
            ...
            <textarea
              rows={8}
              defaultValue="Sekolah Tinggi Teologi Bandung berhasil meraih akreditasi A dari Badan Akreditasi Nasional Perguruan Tinggi (BAN-PT). Pencapaian ini merupakan hasil dari kerja keras seluruh civitas academica dalam meningkatkan kualitas pendidikan dan penelitian."
              required
